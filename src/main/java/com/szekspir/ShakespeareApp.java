...
public class ShakespeareApp {
    ...
    public void init() throws Exception {
        ...
        int choice = JOptionPane.showOptionDialog(null, 
                "Wybierz język / Choose language", "Start",
    ...
    private void loadResources(String filename) {
        try {
            ...
            System.out.println("Załadowano zasoby: " + filename);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Błąd ładowania pliku: " + filename);
            System.exit(1);
        }
    }
    ...
    private void updateInterface() {
        ...
        if (!somethingFound) {
            mainLabel.setText("Błąd: Silnik nie zwrócił żadnych danych.");
        }
    ...
    private void renderRecommendation(Object drlRec) {
        try {
            ...
            try {
                ...
                System.err.println("Błąd ładowania obrazka: " + ex.getMessage());
            }
